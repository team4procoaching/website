...
| DEBT-260514-01 | minor    | M      | Component        | Extract `ContactForm` form-init script into `src/scripts/contactFormController.ts`                                                                                                                                                                                                                                                                                                                                                                                                          | no         | no                 | notes-2026-05-14-contact-form-controller-extraction.md |
