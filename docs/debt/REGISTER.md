...
| DEBT-260514-01 | 2026-05-26 | —      | ContactForm form-init script extracted to `src/scripts/contactFormController.ts` under the `feat/contact-form-prefill-consistency` stream; ADR-0059 formalised the visibility pattern the controller branches operate against. |
