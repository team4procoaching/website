/**
 * Shared SVG icon paths used across data modules.
 *
 * Each export is the inner SVG markup (path elements) for a viewBox of "0 0 24 24".
 * Icons are rendered via `set:html` in components — these values are trusted,
 * static strings. Never use user input here.
 *
